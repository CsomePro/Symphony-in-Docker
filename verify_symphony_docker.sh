...
run_container_check "mise is installed" "mise --version"
run_container_check "elixir is installed" "elixir --version"
...
run_container_warn_check "SSH handshake to github.com" "ssh -o BatchMode=yes -o StrictHostKeyChecking=yes -T git@github.com || test \$? -eq 1"
